...
import piuk.blockchain.android.databinding.ActivityCreateWalletNewBinding
...
class NewCreateWalletActivity : BaseMvpActivity<NewCreateWalletView, NewCreateWalletPresenter>(),
    ...
    private val binding: ActivityCreateWalletNewBinding by lazy {
        ActivityCreateWalletNewBinding.inflate(layoutInflater)
    }
    ...
    companion object {
        ...
        fun start(context: Context) {
            context.startActivity(Intent(context, NewCreateWalletActivity::class.java))
        }
    }
}